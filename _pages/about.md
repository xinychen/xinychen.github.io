...
- [**transdim**](https://github.com/xinychen/transdim): This is our open project for transportation data imputation which covers the missing data imputation and spatiotemporal short-term (or long-term) traffic forecasting using a variety of machine learning and deep learning models. [[20+ stars](https://github.com/xinychen/transdim/stargazers)]

- [**awesome-LaTeX-drawing**](https://github.com/xinychen/awesome-latex-drawing): Drawing Bayesian networks, graphical models and framework for academic studies in LaTeX. [[175+ stars](https://github.com/xinychen/awesome-latex-drawing/stargazers)]
